    ...
    <div className="max-w-6xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2 tracking-wide">Staff Management</h1>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-4 px-4 font-semibold text-gray-900">Permissions</th>
            ...
            <tbody>
              {staff.map((staffMember) => (
                <tr key={staffMember.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-4">
                    <span className="text-gray-900">{staffMember.username}</span>
                  </td>
                  <td className="py-4 px-4">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium capitalize ${
                      staffMember.role === 'admin' ? 'bg-red-100 text-red-700' :
                      staffMember.role === 'artist' ? 'bg-purple-100 text-purple-700' :
